...
class FillPermissionsForCategorieAge extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCategorieAge constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.categorie-age',
            'admin.categorie-age.index',
            'admin.categorie-age.create',
            'admin.categorie-age.show',
            'admin.categorie-age.edit',
            'admin.categorie-age.delete',
            'admin.categorie-age.bulk-delete',
        ]);
