                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'categorie_id'">{{ trans('admin.reservation.columns.categorie_id') }}</th>
                                        <th is='sortable' :column="'id'">{{ trans('admin.reservation.columns.id') }}</th>
                                        <th is='sortable' :column="'montant'">{{ trans('admin.reservation.columns.montant') }}</th>
                                        <th is='sortable' :column="'places'">{{ trans('admin.reservation.columns.places') }}</th>
                                        <th is='sortable' :column="'vol_aller_id'">{{ trans('admin.reservation.columns.vol_aller_id') }}</th>
                                        <th is='sortable' :column="'vol_retour_id'">{{ trans('admin.reservation.columns.vol_retour_id') }}</th>
                                ...
                                <tbody>
                                    ...
                                    <td>@{{ item.categorie_id }}</td>
                                        ...
                                        <td>@{{ item.montant }}</td>
                                        <td>@{{ item.places }}</td>
                                        <td>@{{ item.vol_aller_id }}</td>
                                        <td>@{{ item.vol_retour_id }}</td>
